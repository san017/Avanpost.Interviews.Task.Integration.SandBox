...
namespace Avanpost.Interviews.Task.Integration.SandBox.Tests
{
    public class UnitTest1
    {
        ...
        /*
         * Тест не совсем корректный так как количество свойств у User  = 6, а в тесте указано 5.
         * В задании указано считать password тоже как свойство.
         * За свойства у User считаются следующие:lastName, firstName, middleName, telephoneNumber, isLead, password(Указано в задании)
         * В методе GetAllProperties оставлю закоменнченный код, как верный, с учётом свойства password
         */
        [Theory]
        [InlineData("MSSQL")]
        //[InlineData("POSTGRE")]
        ...
        * В задании указано считать password тоже как свойство.
        * За свойства у User считаются следующие:lastName, firstName, middleName, telephoneNumber, isLead, password(Указано в задании)
        * В методе GetUserProperties оставлю закоменнченный код, как верный, с учётом свойства password
        */
        [Theory]
        [InlineData("MSSQL")]
        //[InlineData("POSTGRE")]
